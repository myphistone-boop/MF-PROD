...
const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="min-h-[50vh] lg:min-h-[75vh] w-full flex flex-col lg:flex-row items-center relative overflow-hidden pt-12 lg:pt-10 pb-12 lg:pb-0 px-6 md:px-12 lg:px-24">
        ...
        <div className={`
          ...
          <h1 className="font-sans font-extrabold text-4xl md:text-7xl lg:text-8xl xl:text-9xl text-brand-dark dark:text-white leading-[0.9] tracking-tighter mb-3 lg:mb-6 uppercase">
            L'ART DE <br />
