...
const About: React.FC = () => {
  return (
    <section className="py-24 lg:py-40 px-6 lg:px-12 relative dark:bg-brand-dark transition-colors duration-500 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="mb-32 lg:mb-56">
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto mb-20">
            ...
            <h2 className="font-sans font-black text-5xl lg:text-8xl text-brand-dark dark:text-white mb-12 tracking-tighter leading-none uppercase">
              BIENVENUE DANS <br/><span className="gradient-text italic">NOTRE UNIVERS</span>
            </h2>
            <div className="bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-black/5 dark:border-white/10 p-10 lg:p-16 rounded-[4rem] shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-brand-cyan via-brand-magenta to-brand-orange"></div>
              <p className="text-2xl lg:text-3xl font-light text-brand-dark/80 dark:text-brand-light/90 leading-relaxed italic font-serif">
              ...
              <p className="mt-12 text-lg lg:text-xl text-brand-dark/60 dark:text-brand-light/60 font-light leading-relaxed max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="relative aspect-[4/5] w-full rounded-[4rem] overflow-hidden shadow-2xl filter contrast-110 transition-all duration-1000 bg-brand-dark">
              ...
              <div className="absolute bottom-12 left-12 right-12 text-white">
                <div className="font-sans font-black text-5xl lg:text-6xl tracking-tighter leading-none mb-4 uppercase">MIKAËL <br/>FERREIRA</div>
                <div className="flex items-center gap-4">
                  <div className="h-[2px] w-12 bg-brand-magenta"></div>
                  <div className="text-brand-magenta uppercase tracking-[0.4em] text-xs font-black">Fondateur MF Prod</div>
                </div>
              </div>
            </div>
            
            <div className="mt-12 p-8 bg-brand-magenta/5 border border-brand-magenta/10 rounded-[2.5rem] italic font-serif text-brand-magenta text-2xl text-center">
          ...
          <div className="lg:col-span-7">
            <div className="space-y-16">
              <div>
                <span className="text-brand-cyan uppercase tracking-[0.5em] font-black text-xs block mb-6">PORTRAIT</span>
                <h3 className="text-4xl lg:text-6xl font-black text-brand-dark dark:text-white tracking-tighter uppercase mb-8">
                  Artiste Polyvalent <br/>et <span className="gradient-text italic">Passionné</span>
                </h3>
                <p className="text-xl lg:text-2xl text-brand-dark/70 dark:text-brand-light/70 font-light leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {/* Musique */}
                <div className="group">
                  <div className="w-14 h-14 rounded-2xl bg-brand-cyan/10 text-brand-cyan flex items-center justify-center mb-6 group-hover:bg-brand-cyan group-hover:text-white transition-all">
                    <Music size={28} />
                  </div>
                  <h4 className="text-xl font-black text-brand-dark dark:text-white uppercase mb-4 tracking-tight">Artiste Musical Accompli</h4>
                  <p className="text-brand-dark/50 dark:text-brand-light/50 font-light leading-relaxed">
                ...
                <div className="group">
                  <div className="w-14 h-14 rounded-2xl bg-brand-magenta/10 text-brand-magenta flex items-center justify-center mb-6 group-hover:bg-brand-magenta group-hover:text-white transition-all">
                    <Star size={28} />
                  </div>
                  <h4 className="text-xl font-black text-brand-dark dark:text-white uppercase mb-4 tracking-tight">Directeur Artistique de Renom</h4>
                  <p className="text-brand-dark/50 dark:text-brand-light/50 font-light leading-relaxed">
                ...
                {/* Cinéma / TV */}
                <div className="group">
                  <div className="w-14 h-14 rounded-2xl bg-brand-orange/10 text-brand-orange flex items-center justify-center mb-6 group-hover:bg-brand-orange group-hover:text-white transition-all">
                    <Tv size={28} />
                  </div>
                  <h4 className="text-xl font-black text-brand-dark dark:text-white uppercase mb-4 tracking-tight">Animateur Cinématographique</h4>
                  <p className="text-brand-dark/50 dark:text-brand-light/50 font-light leading-relaxed">
                ...
                {/* Voix Off */}
                <div className="group">
                  <div className="w-14 h-14 rounded-2xl bg-brand-dark dark:bg-white/10 text-brand-dark dark:text-white flex items-center justify-center mb-6 group-hover:bg-brand-magenta group-hover:text-white transition-all">
                    <Headphones size={28} />
                  </div>
                  <h4 className="text-xl font-black text-brand-dark dark:text-white uppercase mb-4 tracking-tight">Narration Sonore - Voix Off</h4>
                  <p className="text-brand-dark/50 dark:text-brand-light/50 font-light leading-relaxed">
