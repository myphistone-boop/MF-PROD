    ...
    const signaturePoints = [
        {
            ...
            desc: "Créer un environnement chaleureux et authentique permettant aux artistes de se livrer et de partager leurs expériences les plus profondes.",
            icon: <MessageSquare className="w-8 h-8" />
        },
        {
            title: "Récits Exclusifs",
            desc: "Transcender les clichés, plonge au cœur des personnalités pour extraire des anecdotes uniques et mettre en lumière l'âme des œuvres.",
            icon: <Sparkles className="w-8 h-8" />
        },
        {
            title: "Expertise Cinéphile",
            desc: "Passionné de cinéma, conteur de l'art, son expertise cinéphile combinée à sa voix crée une association captivante lors de ses interviews.",
            icon: <Mic className="w-8 h-8" />
        },
        {
            title: "Magnétisme Écran",
            desc: "Une présence à l'écran magnétique et une profonde compréhension offrant une perspective unique sur les films classiques et contemporains.",
    ...
    return (
        <div className="w-full pt-32 lg:pt-48 pb-24 px-6 lg:px-12 bg-brand-light dark:bg-brand-dark transition-colors duration-500 min-h-screen relative overflow-x-hidden">
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                ...
                <div className={`mb-32 transition-all duration-1000 transform ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <p className="text-2xl lg:text-3xl font-light text-brand-dark/70 dark:text-brand-light/90 leading-relaxed font-serif italic border-l-4 border-brand-orange/30 pl-8">
                            "L'art de l'interview réside dans la capacité à créer un lien invisible, où la star s'efface pour laisser place à l'humain."
                        </p>
                        <p className="text-lg text-brand-dark/50 dark:text-brand-light/50 font-light leading-relaxed">
                            Spécialisé dans l'univers du 7ème art, Mikaël Ferreira apporte une signature unique à vos contenus médias. Sa voix et son charisme transforment chaque échange en un moment d'exception.
                        </p>
                    </div>
                </div>
                ...
                <section className="mb-48">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {signaturePoints.map((point, i) => (
                            <div key={i} className="p-10 rounded-[3rem] bg-white dark:bg-brand-dark-soft border border-black/5 dark:border-white/10 shadow-xl group hover:border-brand-orange/40 transition-all duration-500 flex flex-col items-center text-center">
                                <div className="w-16 h-16 rounded-2xl bg-brand-orange/10 text-brand-orange flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                                    {point.icon}
                                </div>
                                <h3 className="text-xl font-black text-brand-dark dark:text-white uppercase mb-4 leading-tight">{point.title}</h3>
                ...
                <section className="mb-48">
                    ...
                    <div className="bg-white/50 dark:bg-white/5 backdrop-blur-xl rounded-[4rem] p-12 lg:p-20 border border-black/5 dark:border-white/10 shadow-2xl">
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 items-center justify-items-center">
                            {partnerLogos.map((logo, i) => (
                                <div key={i} className="group relative flex flex-col items-center gap-6">
                                    <div className="relative w-full aspect-square max-w-[140px] flex items-center justify-center bg-white rounded-3xl p-6 border-2 border-white shadow-lg group-hover:shadow-brand-cyan/20 transition-all duration-500 group-hover:-translate-y-2 transform overflow-hidden">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest text-brand-dark/30 dark:text-white/30 group-hover:text-brand-cyan transition-colors">{logo.name}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                {/* --- SECTION 3: HALL OF FAME (LISTE RÉFÉRENCES) --- */}
                <section className="mb-48">
                    <div className="text-center mb-24">
                        ...
                        <h2 className="text-5xl lg:text-8xl font-black text-brand-dark dark:text-white uppercase tracking-tighter leading-none">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        {references.map((fest, i) => (
                            <div 
                                key={i} 
                                className="bg-white/50 dark:bg-brand-dark-soft/50 backdrop-blur-xl rounded-[3rem] p-12 border border-black/5 dark:border-white/10 group hover:border-brand-orange/40 transition-all duration-500 relative overflow-hidden"
                            >
                                ...
                                <div className="flex justify-between items-start mb-8">
                                    <div className="space-y-2">
                                        <h3 className="text-2xl lg:text-3xl font-black text-brand-dark dark:text-white uppercase leading-tight tracking-tighter">
                                            {fest.name}
                                        </h3>
                                    ...
                                    <div className="w-12 h-12 rounded-2xl bg-black/5 dark:bg-white/5 flex items-center justify-center text-brand-orange/40 group-hover:text-brand-orange transition-colors">
                                        <Star size={20} />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-2 pt-6 border-t border-black/5 dark:border-white/5">
                                    {fest.talents.map((talent, tidx) => (
                                        <div key={tidx} className="flex items-center gap-2">
                                            <span className="text-[11px] font-serif italic font-medium text-brand-dark/70 dark:text-brand-light/70">
                                                {talent}
                                            </span>
                    ...
                    {/* Projets Spéciaux - Symétrie Parfaite (2 colonnes) */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {/* Bloc Animations */}
                        <div className="bg-brand-dark-soft p-12 lg:p-16 rounded-[4rem] border border-white/10 relative overflow-hidden flex flex-col justify-between">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-magenta/10 rounded-full blur-[100px]" />
                            <div>
                                <h3 className="text-3xl font-black text-white uppercase mb-12 flex items-center gap-6">
                                    <div className="w-14 h-14 rounded-2xl bg-brand-magenta/20 flex items-center justify-center text-brand-magenta">
                                        <Tv size={28} />
                                    </div>
                                ...
                                <div className="space-y-8">
                                    {animations.map((anim, i) => (
                                        <div key={i} className="group border-l-2 border-white/5 hover:border-brand-magenta pl-8 transition-all">
                                            <h4 className="text-white font-black text-xl uppercase tracking-tighter">{anim.title}</h4>
                                            <p className="text-brand-magenta text-[10px] font-black uppercase tracking-[0.2em] mt-1">{anim.role}</p>
                                            <p className="text-white/30 text-[9px] uppercase font-bold mt-2">{anim.loc}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        {/* Bloc Film Focus */}
                        <div className="bg-gradient-to-br from-brand-magenta/20 via-brand-dark-soft to-brand-dark-soft p-12 lg:p-16 rounded-[4rem] border border-brand-magenta/20 relative overflow-hidden flex flex-col justify-between group">
                            <div className="absolute top-8 right-8 text-brand-magenta/20">
                                <Clapperboard size={80} strokeWidth={1} />
                            </div>
                            <div>
                                <h3 className="text-3xl font-black text-white uppercase mb-4">PRODUCTION FOCUS</h3>
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-orange text-[9px] font-black text-brand-dark uppercase tracking-widest mb-10">
                                    Court Métrage Engagement
                                </div>
                                <h4 className="text-5xl lg:text-6xl font-black text-white uppercase leading-none mb-8 tracking-tighter">« 13 COUPS »</h4>
                                <p className="text-white/60 text-lg font-light mb-12 italic font-serif leading-relaxed">
                            ...
                            <div className="flex items-center justify-between border-t border-white/10 pt-10">
                                <div className="space-y-1">
                                    <p className="text-[10px] font-black uppercase text-white/40 tracking-widest">Rôle Principal</p>
                                    <p className="text-xl font-black text-white uppercase">Mikaël FERREIRA</p>
                                </div>
                                <div className="text-right space-y-1">
                                    <p className="text-[10px] font-black uppercase text-white/40 tracking-widest">Réalisation</p>
                                    <p className="text-xl font-black text-white uppercase">V. GENTIAL</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="videos" className="mb-48">
                    <div className="text-center mb-24">
                        ...
                        <h2 className="text-5xl lg:text-8xl font-black text-brand-dark dark:text-white uppercase tracking-tighter mb-4 leading-none">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-16">
                        {videoReels.map((vid, i) => (
                            ...
                            >
                                <div 
                                    className="relative aspect-video rounded-[2.5rem] overflow-hidden border-2 border-black/5 dark:border-white/10 bg-black cursor-pointer shadow-xl transition-all duration-500 hover:border-brand-orange hover:shadow-[0_30px_60px_-15px_rgba(255,138,0,0.3)]"
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-md border border-white/40 flex items-center justify-center text-white scale-75 group-hover:scale-100 transition-all duration-500 shadow-2xl">
                                            <PlayCircle size={32} />
                                        </div>
                                    </div>
                                    <div className="absolute bottom-6 left-6 right-6 flex justify-between items-center opacity-0 group-hover:opacity-100 transition-opacity">
                                        <div className="px-3 py-1 rounded-full bg-brand-orange/80 backdrop-blur-md text-[8px] font-black text-white uppercase tracking-widest">Visionner</div>
                                    </div>
                                </div>
                                <div className="mt-6 px-4 text-center">
                                    <h4 className="text-xl font-black text-brand-dark dark:text-white uppercase leading-tight mb-2 group-hover:text-brand-orange transition-colors">{vid.title}</h4>
                                    <p className="text-[10px] font-black uppercase text-brand-dark/30 dark:text-white/30 tracking-[0.2em]">{vid.detail}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                {/* --- FINAL CONTACT --- */}
                <div className="relative p-16 lg:p-24 rounded-[5rem] bg-brand-dark text-white border-2 border-white/10 overflow-hidden shadow-2xl text-center group">
                    ...
                    <h3 className="text-4xl lg:text-7xl font-black uppercase tracking-tighter mb-10 leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Button className="py-8 px-20 text-xl shadow-[0_30px_60px_-15px_rgba(255,138,0,0.3)]" onClick={() => handleBooking()}>Engager Mikaël Ferreira</Button>
                    </div>
                </div>
            </div>
            ...
            {activeVideo && (
                ...
                >
                    <button 
                        className="absolute top-8 right-8 w-14 h-14 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-brand-orange transition-colors z-50 shadow-2xl"
                        onClick={() => setActiveVideo(null)}
                    >
                        <X size={32} />
                    </button>

                    <div className="relative w-full max-w-6xl aspect-video rounded-3xl overflow-hidden shadow-[0_0_100px_rgba(255,138,0,0.3)] bg-black" onClick={e => e.stopPropagation()}>
                        <iframe
