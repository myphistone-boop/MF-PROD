        ...
        <div className="w-full min-h-screen pt-32 lg:pt-40 relative bg-brand-light dark:bg-brand-dark transition-colors duration-500">
            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 pb-20">
                <div className={`lg:col-span-8 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="space-y-12 lg:space-y-20 text-brand-dark/80 dark:text-brand-light/80 font-sans">
                        ...
                        <blockquote className="border-l-8 border-brand-magenta pl-10 lg:pl-16 py-8 my-16 bg-white dark:bg-white/5 rounded-r-3xl text-brand-dark dark:text-white font-sans font-black text-3xl lg:text-5xl italic tracking-tight shadow-2xl transition-colors duration-500">
                            "Une explosion de talents au service des plus grandes légendes."
                        </blockquote>

                        <h3 className="font-sans font-black text-4xl lg:text-6xl text-brand-dark dark:text-white pt-10 mb-12 tracking-tight">LES PILIERS DU SPECTACLE</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[
                                ...
                                <div key={i} className="bg-white dark:bg-brand-dark-soft/80 backdrop-blur-3xl p-10 rounded-[3rem] border-2 border-black/5 dark:border-white/10 hover:border-brand-magenta/40 transition-all h-full flex flex-col shadow-xl dark:shadow-2xl group transition-colors duration-500">
                                    <div className="text-brand-cyan mb-8 group-hover:scale-110 transition-transform">{val.icon}</div>
                                    <h4 className="font-sans font-black text-3xl text-brand-dark dark:text-white mb-4 tracking-tight">{val.title}</h4>
                                    <p className="text-lg lg:text-xl text-brand-dark/60 dark:text-brand-light/60 leading-relaxed font-light">{val.text}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="lg:col-span-4 relative">
                    <div className={`sticky top-32 lg:top-48 transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                        <div className="bg-white dark:bg-brand-dark-soft border-2 border-black/5 dark:border-white/10 p-12 rounded-[3.5rem] relative overflow-hidden shadow-2xl group transition-colors duration-500">
                            ...
                            <div className="relative z-10">
                                <h3 className="font-sans font-black text-4xl text-brand-dark dark:text-white mb-6 tracking-tight">RÉSERVER <br/>LE SHOW</h3>
                                ...
                                <div className="space-y-6 mb-12">
                                    <div className="flex justify-between items-center text-lg border-b border-black/5 dark:border-white/10 pb-4">
                                        <span className="text-brand-dark/40 dark:text-brand-light/40 uppercase tracking-widest text-[10px] font-black">Durée</span>
                                        <span className="text-brand-dark dark:text-white font-black">2H15</span>
                                    </div>
                                    <div className="flex justify-between items-center text-lg border-b border-black/5 dark:border-white/10 pb-4">
                                        <span className="text-brand-dark/40 dark:text-brand-light/40 uppercase tracking-widest text-[10px] font-black">Effectif</span>
                                        <span className="text-brand-dark dark:text-white font-black">12 ARTISTES</span>
                                    </div>
                                    <div className="flex justify-between items-center text-lg border-b border-black/5 dark:border-white/10 pb-4">
                                        <span className="text-brand-dark/40 dark:text-brand-light/40 uppercase tracking-widest text-[10px] font-black">Status</span>
